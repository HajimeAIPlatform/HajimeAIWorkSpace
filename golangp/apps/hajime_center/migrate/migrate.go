...
func main() {
	...
	//}
	err := initializers.DB.AutoMigrate(&models.User{}, &models.ReferralCode{}, &models.HajimeApps{}, &models.UserAsset{}, &models.UserWithdraw{}, models.Dataset{}, &models.BillingHistory{})
