...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:pTK/l/3qYIKaRXuHnEnIf7Y5NxfRPfpb7dis6/gdlVI=",
        version = "v1.9.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:AdFhPTLzdJsoAfaRk7tG/zBhXjpy2VRBWdFM5r3CsZ8=",
        version = "v1.0.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:r+g0bk4LPCW2v4+Ls7aeNgGme7JYdNDQ2VtvlNUfBh0=",
        version = "v1.2.1",
    )
    go_repository(
