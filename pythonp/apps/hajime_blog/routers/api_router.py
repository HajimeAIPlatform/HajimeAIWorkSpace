...
from pythonp.apps.hajime_blog.db.models import UserDeposit, User, UserStat, UserNewsSubscribe, UserAssetList, MinerOrder
from pythonp.apps.hajime_blog.db.schemas import SignLoginModel, GenericResponseModel, UserAuthResponseModel, ReferModel, NewsSubscribeModel, \
...
from pythonp.apps.hajime_blog.utils.common import error_return, success_return

router = APIRouter(prefix="/api", tags=["api"])


from pythonp.apps.hajime_blog.utils.x_auth import get_uid_by_token
