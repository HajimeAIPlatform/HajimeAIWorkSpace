...
# BOT_TOKEN="7805651398:AAHCG40KeHJrqRqxXmlA_xDsEWwmMwOpnug"   # fortune_tellerFortuneCookieBot
...
# Prod服务器：
# bash utils/set_webhook.sh https://fortune_teller.pointer.ai/telebot/bot_fortune_teller/webhook

# bash utils/set_webhook.sh https://fortune_teller.pointer.ai/telebot/bot2/webhook
