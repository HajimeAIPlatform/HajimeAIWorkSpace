...
# 加载环境变量
load_dotenv()
from pythonp.apps.fortune_teller.email_service.email_monitor_thread import EmailMonitor
...
def run_gunicorn():
    ...
    from pythonp.apps.fortune_teller.app import app
