...
from pythonp.apps.fortune_teller.service.ton.tc_storage import TcStorage, TransactionManager
...
from pythonp.apps.fortune_teller.service.ton.views import save_to_transaction_info_to_db
