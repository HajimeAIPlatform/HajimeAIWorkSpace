...
import pythonp.apps.fortune_teller.service.fortune_teller_bot.state as TaskState
...
from pythonp.apps.fortune_teller.service.ton.tc_storage import UserActivityTracker
