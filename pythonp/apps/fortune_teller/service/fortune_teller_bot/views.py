...
from pythonp.apps.fortune_teller.service.dify.views import chat_blocking, chat_streaming, chat_workflow, chat_decode
from pythonp.apps.fortune_teller.service.binance.views import handle_binance_command
from pythonp.apps.fortune_teller.service.binance.utils import get_all_prices, process_recommendation
import pythonp.apps.fortune_teller.service.ton.views as ton_module
from pythonp.apps.fortune_teller.service.fortune_teller_bot.commands import set_commands
from pythonp.apps.fortune_teller.service.fortune_teller_bot.wallet_menu_callback import set_handlers
import pythonp.apps.fortune_teller.service.fortune_teller_bot.state as ChatStatus
from pythonp.apps.fortune_teller.service.fortune_teller_bot.i18n_helper import I18nHelper
from pythonp.apps.fortune_teller.service.fortune_teller_bot.keyboards import KeyboardFactory
from pythonp.apps.fortune_teller.service.ton.tc_storage import DailyFortune, UserActivityTracker, ExceptionStorage
from pythonp.apps.fortune_teller.models.transaction import UserPoints
from pythonp.apps.fortune_teller.static.static import get_images_path
from pythonp.apps.fortune_teller.utils.debug_tools import get_user_friendly_error_info
...
async def run_fortune_teller_bot():
...
# 创建Flask Blueprint
fortune_teller_bot = Blueprint('fortune_teller_bot', __name__)
...
@fortune_teller_bot.route('/binance/price', methods=['GET'])
...
@fortune_teller_bot.route('/webhook', methods=['POST'])
# @run_async
async def webhook():
    chat_id = None
    try:
...
async def send_recommendations(update, role: str):
    ...
    if not recommended_tokens:
        ...
        dialog = i18n.get_dialog("error_chat")
        await target.message.reply_text(escape(dialog), parse_mode="MarkdownV2")
        return
