...
from pythonp.apps.tokenfate.service.dify.views import chat_blocking_fortune_teller, chat_streaming, chat_workflow, chat_decode
...
from pythonp.apps.tokenfate.service.bot_fortune_teller.commands import set_commands
from pythonp.apps.tokenfate.service.bot_fortune_teller.wallet_menu_callback import set_handlers
import pythonp.apps.tokenfate.service.bot_fortune_teller.state as ChatStatus
from pythonp.apps.tokenfate.service.bot_fortune_teller.i18n_helper import I18nHelper
from pythonp.apps.tokenfate.service.bot_fortune_teller.keyboards import KeyboardFactory
...
@bot_fortune_teller.route('/binance/price', methods=['GET'])
    ...
    try:
        ...
        # Process update with the application
            ...
            if update.message.photo:
                ...
                api_responseponse = chat_blocking_fortune_teller({
