...
# 设置 URL 参数
WEBHOOK_URL=$1
# BOT_TOKEN="7886534816:AAF6GrZXaESSw0c7sFdWEbCrBQAd3_vJZ04" # tokenfate
...
# bash utils/set_webhook_tarot.sh  https://4a83-14-155-107-35.ngrok-free.app/telebot/bot/webhook
# Dev服务器:
